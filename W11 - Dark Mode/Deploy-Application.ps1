...
Try
{
	...
	[string]$appName = 'W10/W11 - Set dark mode'
	[string]$appVersion = '1.0.0.1'
	[string]$appArch = 'x86/x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '2021-08-20'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair')
	{
		...
		# Set reg value for all users
		[scriptblock]$HKCURegistrySettings = {
			
			Set-RegistryKey -Key 'HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize' -Name 'AppsUseLightTheme' -Value 0 -Type Dword -SID $UserProfile.SID
			Set-RegistryKey -Key 'HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize' -Name 'SystemUsesLightTheme' -Value 0 -Type Dword -SID $UserProfile.SID
